...
namespace BookManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240927190758_BooksStockAmoutBorrowed2")]
    partial class BooksStockAmoutBorrowed2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookManagement.Core.Entities.BookStock", b =>
                {
                    ...
                    b.HasAlternateKey("BookId")
                        .HasName("UQ_BookStock_BookId");

                    b.HasIndex("BookId")
                        .IsUnique()
                        .HasDatabaseName("IX_BookStocks_BookId");
            ...
            modelBuilder.Entity("BookManagement.Core.Entities.Loan", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("IX_Lans_UserId");
